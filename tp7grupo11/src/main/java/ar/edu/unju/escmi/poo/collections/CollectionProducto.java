...
public abstract class CollectionProducto {
	...
	public static List<Producto> getProductos() {
		if(productos==null) {
			...
			productos.add(new Producto(6,"Aire Acondicionado","Split On/Off 2750W FC",69999,"ARGENTINA","Hisense"));
			productos.add(new Producto(7,"Aire Acondicionado","Inverter 3300W FC",13000,"ARGENTINA","Philco"));
			...
			productos.add(new Producto(12,"Celular","Galaxy A33",50000,"ARGENTINA","SAMSUNG"));
			productos.add(new Producto(13,"Celular","SM-A325/4+128",40200,"ARGENTINA","SAMSUNG"));
			productos.add(new Producto(14,"Celular","Moto G52 Negro Azul",80000,"ARGENTINA","MOTOROLA"));
			productos.add(new Producto(15,"Celular","Smartphone 6' 32GB+1GB",16200,"ARGENTINA","SAMSUNG"));
